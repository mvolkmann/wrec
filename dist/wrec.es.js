...
const Is = at(Array.prototype.forEach), fc = at(Array.prototype.lastIndexOf), Or = at(Array.prototype.pop), Ke = at(Array.prototype.push), pc = at(Array.prototype.splice), ks = at(String.prototype.toLowerCase), bn = at(String.prototype.toString), yn = at(String.prototype.match), He = at(String.prototype.replace), mc = at(String.prototype.indexOf), Sc = at(String.prototype.trim), dt = at(Object.prototype.hasOwnProperty), rt = at(RegExp.prototype.test), We = Cc(TypeError);
function at(s) {
  return function(t) {
...
function Nt(s) {
  ...
  for (const [e, n] of Po(s))
    dt(s, e) && (Array.isArray(n) ? t[e] = bc(n) : n && typeof n == "object" && n.constructor === Object ? t[e] = Nt(n) : t[e] = n);
  return t;
}
function Ye(s, t) {
  for (; s !== null; ) {
...
function Xo() {
  let s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : vc();
  const t = (E) => Xo(E);
  ...
  const lr = T({}, [...Qr, ...En, ...In, ...wn, ...Gr]);
  let j = null;
  const ur = T({}, [...Lr, ...Rn, ...Kr, ...ws]);
  let L = Object.seal(Ms(null, {
    tagNameCheck: {
      writable: !0,
      configurable: !1,
      enumerable: !0,
  ...
  const rc = T({}, [Cs, bs, Qt], bn);
  let ys = T({}, ["mi", "mo", "mn", "ms", "mtext"]), Es = T({}, ["annotation-xml"]);
  const oc = T({}, ["title", "style", "font", "a", "script"]);
  let Le = null;
  const Ac = ["application/xhtml+xml", "text/html"], ac = "text/html";
  let U = null, be = null;
  const cc = e.createElement("form"), br = function(l) {
    return l instanceof RegExp || l instanceof Function;
  }, pn = function() {
    let l = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (!(be && be === l)) {
      if ((!l || typeof l != "object") && (l = {}), l = Nt(l), Le = // eslint-disable-next-line unicorn/prefer-includes
      Ac.indexOf(l.PARSER_MEDIA_TYPE) === -1 ? ac : l.PARSER_MEDIA_TYPE, U = Le === "application/xhtml+xml" ? bn : ks, Z = dt(l, "ALLOWED_TAGS") ? T({}, l.ALLOWED_TAGS, U) : lr, j = dt(l, "ALLOWED_ATTR") ? T({}, l.ALLOWED_ATTR, U) : ur, fn = dt(l, "ALLOWED_NAMESPACES") ? T({}, l.ALLOWED_NAMESPACES, bn) : rc, gn = dt(l, "ADD_URI_SAFE_ATTR") ? T(Nt(Cr), l.ADD_URI_SAFE_ATTR, U) : Cr, mr = dt(l, "ADD_DATA_URI_TAGS") ? T(Nt(Sr), l.ADD_DATA_URI_TAGS, U) : Sr, Dt = dt(l, "FORBID_CONTENTS") ? T({}, l.FORBID_CONTENTS, U) : hn, Qe = dt(l, "FORBID_TAGS") ? T({}, l.FORBID_TAGS, U) : Nt({}), fs = dt(l, "FORBID_ATTR") ? T({}, l.FORBID_ATTR, U) : Nt({}), Se = dt(l, "USE_PROFILES") ? l.USE_PROFILES : !1, hr = l.ALLOW_ARIA_ATTR !== !1, an = l.ALLOW_DATA_ATTR !== !1, gr = l.ALLOW_UNKNOWN_PROTOCOLS || !1, dr = l.ALLOW_SELF_CLOSE_IN_ATTR !== !1, pe = l.SAFE_FOR_TEMPLATES || !1, ps = l.SAFE_FOR_XML !== !1, se = l.WHOLE_DOCUMENT || !1, me = l.RETURN_DOM || !1, ms = l.RETURN_DOM_FRAGMENT || !1, Ss = l.RETURN_TRUSTED_TYPE || !1, ln = l.FORCE_BODY || !1, fr = l.SANITIZE_DOM !== !1, pr = l.SANITIZE_NAMED_PROPS || !1, un = l.KEEP_CONTENT !== !1, Ge = l.IN_PLACE || !1, cr = l.ALLOWED_URI_REGEXP || Zo, Ce = l.NAMESPACE || Qt, ys = l.MATHML_TEXT_INTEGRATION_POINTS || ys, Es = l.HTML_INTEGRATION_POINTS || Es, L = l.CUSTOM_ELEMENT_HANDLING || {}, l.CUSTOM_ELEMENT_HANDLING && br(l.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (L.tagNameCheck = l.CUSTOM_ELEMENT_HANDLING.tagNameCheck), l.CUSTOM_ELEMENT_HANDLING && br(l.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (L.attributeNameCheck = l.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), l.CUSTOM_ELEMENT_HANDLING && typeof l.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (L.allowCustomizedBuiltInElements = l.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), pe && (an = !1), ms && (me = !0), Se && (Z = T({}, Gr), j = Ms(null), Se.html === !0 && (T(Z, Qr), T(j, Lr)), Se.svg === !0 && (T(Z, En), T(j, Rn), T(j, ws)), Se.svgFilters === !0 && (T(Z, In), T(j, Rn), T(j, ws)), Se.mathMl === !0 && (T(Z, wn), T(j, Kr), T(j, ws))), dt(l, "ADD_TAGS") || (Jt.tagCheck = null), dt(l, "ADD_ATTR") || (Jt.attributeCheck = null), l.ADD_TAGS && (typeof l.ADD_TAGS == "function" ? Jt.tagCheck = l.ADD_TAGS : (Z === lr && (Z = Nt(Z)), T(Z, l.ADD_TAGS, U))), l.ADD_ATTR && (typeof l.ADD_ATTR == "function" ? Jt.attributeCheck = l.ADD_ATTR : (j === ur && (j = Nt(j)), T(j, l.ADD_ATTR, U))), l.ADD_URI_SAFE_ATTR && T(gn, l.ADD_URI_SAFE_ATTR, U), l.FORBID_CONTENTS && (Dt === hn && (Dt = Nt(Dt)), T(Dt, l.FORBID_CONTENTS, U)), l.ADD_FORBID_CONTENTS && (Dt === hn && (Dt = Nt(Dt)), T(Dt, l.ADD_FORBID_CONTENTS, U)), un && (Z["#text"] = !0), se && T(Z, ["html", "head", "body"]), Z.table && (T(Z, ["tbody"]), delete Qe.tbody), l.TRUSTED_TYPES_POLICY) {
        ...
        k === void 0 && (k = Fc(b, i)), k !== null && typeof et == "string" && (et = k.createHTML(""));
      At && At(l), be = l;
    }
  }, yr = T({}, [...En, ...In, ...yc]), Er = T({}, [...wn, ...Ec]), lc = function(l) {
    let f = mt(l);
    (!f || !f.tagName) && (f = {
      namespaceURI: Ce,
      tagName: "template"
    ...
    return fn[l.namespaceURI] ? l.namespaceURI === bs ? f.namespaceURI === Qt ? y === "svg" : f.namespaceURI === Cs ? y === "svg" && (O === "annotation-xml" || ys[O]) : !!yr[y] : l.namespaceURI === Cs ? f.namespaceURI === Qt ? y === "math" : f.namespaceURI === bs ? y === "math" && Es[O] : !!Er[y] : l.namespaceURI === Qt ? f.namespaceURI === bs && !Es[O] || f.namespaceURI === Cs && !ys[O] ? !1 : !Er[y] && (oc[y] || !yr[y]) : !!(Le === "application/xhtml+xml" && fn[l.namespaceURI]) : !1;
  }, xt = function(l) {
    Ke(t.removed, {
      element: l
    });
    ...
    Le === "application/xhtml+xml" && Ce === Qt && (l = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + l + "</body></html>");
    const O = k ? k.createHTML(l) : l;
    if (Ce === Qt)
      try {
        f = new S().parseFromString(O, Le);
      } catch {
      }
  ...
  const Br = function(l) {
    let f = null;
    if (Gt(N.beforeSanitizeElements, l, null), mn(l))
      return xt(l), !0;
    const y = U(l.nodeName);
    if (Gt(N.uponSanitizeElement, l, {
      tagName: y,
      allowedTags: Z
    ...
    if (!(Jt.tagCheck instanceof Function && Jt.tagCheck(y)) && (!Z[y] || Qe[y])) {
      if (!Qe[y] && Dr(y) && (L.tagNameCheck instanceof RegExp && rt(L.tagNameCheck, y) || L.tagNameCheck instanceof Function && L.tagNameCheck(y)))
        return !1;
      if (un && !Dt[y]) {
        ...
        if (st && O) {
          ...
          for (let lt = H - 1; lt >= 0; --lt) {
            const Lt = tt(st[lt], !0);
            Lt.__removalCount = (l.__removalCount || 0) + 1, O.insertBefore(Lt, K(l));
          }
        }
      }
      return xt(l), !0;
    }
    return l instanceof c && !lc(l) || (y === "noscript" || y === "noembed" || y === "noframes") && rt(/<\/no(script|embed|frames)/i, l.innerHTML) ? (xt(l), !0) : (pe && l.nodeType === Ue.text && (f = l.textContent, Is([Ut, _t, Oe], (O) => {
      f = He(f, O, " ");
    }), l.textContent !== f && (Ke(t.removed, {
      element: l.cloneNode()
    }), l.textContent = f)), Gt(N.afterSanitizeElements, l, null), !1);
  }, Tr = function(l, f, y) {
    if (fs[f] || fr && (f === "id" || f === "name") && (y in e || y in cc))
      return !1;
    if (!(an && !fs[f] && rt(hs, f))) {
      if (!(hr && rt(gs, f))) {
        if (!(Jt.attributeCheck instanceof Function && Jt.attributeCheck(f, l))) {
          if (!j[f] || fs[f]) {
            if (
              ...
              !(Dr(l) && (L.tagNameCheck instanceof RegExp && rt(L.tagNameCheck, l) || L.tagNameCheck instanceof Function && L.tagNameCheck(l)) && (L.attributeNameCheck instanceof RegExp && rt(L.attributeNameCheck, f) || L.attributeNameCheck instanceof Function && L.attributeNameCheck(f, l)) || // Alternative, second condition checks if it's an `is`-attribute, AND
              // the value passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.tagNameCheck
              f === "is" && L.allowCustomizedBuiltInElements && (L.tagNameCheck instanceof RegExp && rt(L.tagNameCheck, y) || L.tagNameCheck instanceof Function && L.tagNameCheck(y)))
            ) return !1;
          } else if (!gn[f]) {
            if (!rt(cr, He(y, ee, ""))) {
              if (!((f === "src" || f === "xlink:href" || f === "href") && l !== "script" && mc(y, "data:") === 0 && mr[l])) {
                if (!(gr && !rt(ds, He(y, ee, "")))) {
                  if (y)
                    return !1;
                }
    ...
    return l !== "annotation-xml" && yn(l, nc);
  }, xr = function(l) {
    Gt(N.beforeSanitizeAttributes, l, null);
    const {
      attributes: f
    } = l;
    if (!f || mn(l))
    ...
    for (; O--; ) {
      ...
      let q = H === "value" ? Sn : Sc(Sn);
      if (y.attrName = ye, y.attrValue = q, y.keepAttr = !0, y.forceKeepAttr = void 0, Gt(N.uponSanitizeAttribute, l, y), q = y.attrValue, pr && (ye === "id" || ye === "name") && (ne(H, l), q = ic + q), ps && rt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, q)) {
        ne(H, l);
        continue;
      }
    ...
    Gt(N.afterSanitizeAttributes, l, null);
  }, uc = function E(l) {
    let f = null;
    const y = wr(l);
    for (Gt(N.beforeSanitizeShadowDOM, l, null); f = y.nextNode(); )
      Gt(N.uponSanitizeShadowNode, f, null), Br(f), xr(f), f.content instanceof r && E(f.content);
    Gt(N.afterSanitizeShadowDOM, l, null);
  };
  return t.sanitize = function(E) {
    ...
    if (!t.isSupported)
      return E;
    if (cn || pn(l), t.removed = [], typeof E == "string" && (Ge = !1), Ge) {
      if (E.nodeName) {
        const Lt = U(E.nodeName);
        if (!Z[Lt] || Qe[Lt])
    ...
    const H = wr(Ge ? E : f);
    for (; O = H.nextNode(); )
      Br(O), xr(O), O.content instanceof r && uc(O.content);
    if (Ge)
      return E;
    if (me) {
      if (ms)
...
` + lt), pe && Is([Ut, _t, Oe], (Lt) => {
    ...
    if (l !== void 0) {
      const f = fc(N[E], l);
      return f === -1 ? void 0 : pc(N[E], f, 1)[0];
    }
    return Or(N[E]);
...
function kc(s) {
  var t;
  return s >= 55296 && s <= 57343 || s > 1114111 ? 65533 : (t = Mc.get(s)) !== null && t !== void 0 ? t : s;
}
function zo(s) {
  const t = (
...
const Ur = 32;
function gi(s) {
  return s >= G.ZERO && s <= G.NINE;
}
function Gc(s) {
  return s >= G.UPPER_A && s <= G.UPPER_F || s >= G.LOWER_A && s <= G.LOWER_F;
}
function Lc(s) {
  return s >= G.UPPER_A && s <= G.UPPER_Z || s >= G.LOWER_A && s <= G.LOWER_Z || gi(s);
}
function Kc(s) {
  return s === G.EQUALS || Lc(s);
}
var V;
(function(s) {
...
class Hc {
  ...
  write(t, e) {
    switch (this.state) {
      case V.EntityStart:
        return t.charCodeAt(e) === G.NUM ? (this.state = V.NumericStart, this.consumed += 1, this.stateNumericStart(t, e + 1)) : (this.state = V.NamedEntity, this.stateNamedEntity(t, e));
      case V.NumericStart:
  ...
  stateNumericStart(t, e) {
    return e >= t.length ? -1 : (t.charCodeAt(e) | Ur) === G.LOWER_X ? (this.state = V.NumericHex, this.consumed += 1, this.stateNumericHex(t, e + 1)) : (this.state = V.NumericDecimal, this.stateNumericDecimal(t, e));
  }
  /**
  ...
  stateNumericHex(t, e) {
    for (; e < t.length; ) {
      ...
      if (gi(n) || Gc(n)) {
        const i = n <= G.NINE ? n - G.ZERO : (n | Ur) - G.LOWER_A + 10;
  ...
  stateNumericDecimal(t, e) {
    for (; e < t.length; ) {
      const n = t.charCodeAt(e);
      if (gi(n))
        this.result = this.result * 10 + (n - G.ZERO), this.consumed++, e++;
      else
  ...
  emitNumericEntity(t, e) {
    ...
    if (t === G.SEMI)
      ...
      return 0;
    return this.emitCodePoint(kc(this.result), this.consumed), this.errors && (t !== G.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(t, e) {
    ...
    for (; e < t.length; ) {
      ...
      if (o === G.SEMI && r !== 0 && (i & ot.FLAG13) !== 0)
        return this.emitNamedEntityData(this.treeIndex, r, this.consumed + this.excess);
      if (this.treeIndex = Wc(n, i, this.treeIndex + Math.max(1, r), o), this.treeIndex < 0)
        ...
        Kc(o)) ? 0 : this.emitNotTerminatedNamedEntity();
...
class $o {
  constructor({ xmlMode: t = !1, decodeEntities: e = !0 }, n) {
    this.cbs = n, this.state = d.Text, this.buffer = "", this.sectionStart = 0, this.index = 0, this.entityStart = 0, this.baseState = d.Text, this.isSpecial = !1, this.running = !0, this.offset = 0, this.currentSequence = void 0, this.sequenceIndex = 0, this.xmlMode = t, this.decodeEntities = e, this.entityDecoder = new Hc(t ? Qc : Oc, (i, r) => this.emitCodePoint(i, r));
  }
  reset() {
...
const we = /* @__PURE__ */ new Set([
  ...
  "datalist",
  "textarea"
]), F = /* @__PURE__ */ new Set(["p"]), _r = /* @__PURE__ */ new Set(["thead", "tbody"]), Jr = /* @__PURE__ */ new Set(["dd", "dt"]), Pr = /* @__PURE__ */ new Set(["rt", "rp"]), Uc = /* @__PURE__ */ new Map([
...
let Pc = class {
  ...
  emitOpenTag(t) {
    ...
    const o = this.htmlMode && Uc.get(t);
    if (o)
...
const Vc = J.Root, Xc = J.Text, jc = J.Directive, qc = J.Comment, zc = J.Script, $c = J.Style, tl = J.Tag, el = J.CDATA, sl = J.Doctype;
function Ct(s) {
  return Zc(s);
}
function Ri(s) {
...
const Xr = /["&'<>$\x80-\uFFFF]/g, il = /* @__PURE__ */ new Map([
  [34, "&quot;"],
  [38, "&amp;"],
  [39, "&apos;"],
  [60, "&lt;"],
...
function eA(s) {
  ...
  for (; (n = Xr.exec(s)) !== null; ) {
    const i = n.index, r = s.charCodeAt(i), o = il.get(r);
    o !== void 0 ? (t += s.substring(e, i) + o, e = i + 1) : (t += `${s.substring(e, i)}&#x${rl(s, i).toString(16)};`, e = Xr.lastIndex += +((r & 64512) === 55296));
  }
  return t + s.substr(e);
}
function sA(s, t) {
...
const ol = sA(/["&\u00A0]/g, /* @__PURE__ */ new Map([
  [34, "&quot;"],
  [38, "&amp;"],
  [160, "&nbsp;"]
  ...
  "radialGradient",
  "textPath"
].map((s) => [s.toLowerCase(), s])), cl = new Map([
  "definitionURL",
  "attributeName",
  "attributeType",
  "baseFrequency",
  ...
  "yChannelSelector",
  "zoomAndPan"
].map((s) => [s.toLowerCase(), s])), ll = /* @__PURE__ */ new Set([
  "style",
  "script",
  "xmp",
  "iframe",
...
function hl(s, t) {
  ...
  if (!s)
    return;
  const n = ((e = t.encodeEntities) !== null && e !== void 0 ? e : t.decodeEntities) === !1 ? ul : t.xmlMode || t.encodeEntities !== "utf8" ? eA : ol;
  return Object.keys(s).map((i) => {
    var r, o;
    const A = (r = s[i]) !== null && r !== void 0 ? r : "";
    return t.xmlMode === "foreign" && (i = (o = cl.get(i)) !== null && o !== void 0 ? o : i), !t.emptyAttrs && !t.xmlMode && A === "" ? i : `${i}="${n(A)}"`;
  }).join(" ");
}
...
const dl = /* @__PURE__ */ new Set([
  ...
  "desc",
  "title"
]), fl = /* @__PURE__ */ new Set(["svg", "math"]);
function pl(s, t) {
  var e;
  t.xmlMode === "foreign" && (s.name = (e = al.get(s.name)) !== null && e !== void 0 ? e : s.name, s.parent && dl.has(s.parent.name) && (t = { ...t, xmlMode: !1 })), !t.xmlMode && fl.has(s.name) && (t = { ...t, xmlMode: "foreign" });
  let n = `<${s.name}`;
  const i = hl(s.attribs, t);
...
function Sl(s, t) {
  var e;
  let n = s.data || "";
  return ((e = t.encodeEntities) !== null && e !== void 0 ? e : t.decodeEntities) !== !1 && !(!t.xmlMode && s.parent && ll.has(s.parent.name)) && (n = t.xmlMode || t.encodeEntities !== "utf8" ? eA(n) : Al(n)), n;
}
function Cl(s) {
...
function aA(s) {
  ...
  return t.length === 0 ? null : t.reduce(Ol);
}
function Ql(s, t) {
  const e = aA(s);
  return e ? e(t) : !0;
...
function lA(s) {
  const t = _s(Zl, s);
  return t ? t.name === "feed" ? Ul(t) : _l(t) : null;
}
function Ul(s) {
  var t;
...
const xi = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  findOne: Ti,
  findOneChild: Ml,
  getAttributeValue: Il,
  getChildren: iA,
  getElementById: Ll,
  getElements: Gl,
  getElementsByClassName: Kl,
  ...
  isTag: Ct,
  isText: De,
  nextElementSibling: Bl,
  prepend: Fl,
  prependChild: vl,
  prevElementSibling: Tl,
  removeElement: is,
  removeSubsets: Wl,
  replaceElement: Dl,
  testElement: Ql,
  ...
  Tokenizer: $o,
  getFeed: lA
}, Symbol.toStringTag, { value: "Module" })), zt = -1, x = 1, $ = 2, it = 3, Ot = 4, Wt = 8, Ae = 9, xe = 10, Ht = 11, Xl = /* @__PURE__ */ new Set(["ARTICLE", "ASIDE", "BLOCKQUOTE", "BODY", "BR", "BUTTON", "CANVAS", "CAPTION", "COL", "COLGROUP", "DD", "DIV", "DL", "DT", "EMBED", "FIELDSET", "FIGCAPTION", "FIGURE", "FOOTER", "FORM", "H1", "H2", "H3", "H4", "H5", "H6", "LI", "UL", "OL", "P"]), jl = -1, ql = 1, zl = 4, $l = 8, tu = 128, eu = 1, qr = 2, zr = 4, su = 8, nu = 16, iu = 32, Js = "http://www.w3.org/2000/svg", {
  assign: ru,
  create: ou,
  defineProperties: Au,
  entries: au,
...
}, to = pA("disconnectedCallback", !1), lu = (s) => {
  if (en) {
...
const { Parser: hu } = Vl, re = (s, t, e) => {
  ...
  const c = new hu({
    ...
    onopentag(a, u) {
      ...
      let S = r[w];
      for (const b of cu(u))
        gu(r, S, s.createAttribute(b), u[b], n);
    },
    // #text, #comment
    oncomment(a) {
...
function Su({ currentTarget: s, target: t }) {
  const e = Gs.get(s);
  if (e && e.has(this.type)) {
    ...
    for (const [i, r] of n)
      if (r && r.once && n.delete(i), mu(this, i))
        break;
...
class vi {
  ...
  dispatchEvent(t) {
    ...
    return t._path.some(Su, t), t._path = [], t.eventPhase = t.NONE, !t.defaultPrevented;
  }
}
...
let de = class extends vi {
  ...
  compareDocumentPosition(t) {
    ...
    if (this !== t) {
      ...
      if (n < i)
        e += zr, this.contains(t) && (e += nu);
      else if (i < n)
        e += qr, t.contains(this) && (e += su);
      else if (n && i) {
...
const { replace: Cu } = "", bu = /[<>&\xA0]/g, yu = {
  " ": "&#160;",
  "&": "&amp;",
  "<": "&lt;",
  ">": "&gt;"
}, Eu = (s) => yu[s], Fi = (s) => Cu.call(s, bu, Eu), Iu = /"/g;
let os = class wA extends de {
  ...
  toString() {
    ...
    if (pu.has(t) && !e)
      return $t(this) ? t : `${t}=""`;
    const n = ($t(this) ? e : Fi(e)).replace(Iu, "&quot;");
    return `${t}="${n}"`;
  }
  toJSON() {
    const t = [];
...
const RA = ({ ownerDocument: s, parentNode: t }) => {
  ...
  (s || e) && (dA(s, e), t[X] = null, gt(t)[m] = null), n && (t.parentNode = null, ze(t, n), i === x && lu(t));
};
...
const ro = /^[^\\#]?(?:\\(?:[\da-f]{1,6}\s?|.)|[\w\-\u00b0-\uFFFF])+/, Tu = /\\([\da-f]{1,6}\s?|(\s)|.)/gi, Du = /* @__PURE__ */ new Map([
  [126, _.Element],
  [94, _.Start],
  [36, _.End],
  [42, _.Any],
...
const vu = /* @__PURE__ */ new Set(["contains", "icontains"]);
function Fu(s, t, e) {
  ...
  t: for (; e < t.length; ) {
    ...
    switch (S) {
      ...
      case 91: {
        ...
        let tt = _.Exists;
        const Tt = Du.get(t.charCodeAt(e));
        if (Tt) {
...
function GA(s) {
  ...
  return s.type === R.Attribute ? (n = (e = Mu.get(s.action)) !== null && e !== void 0 ? e : 4, s.action === _.Equals && s.name === "id" && (n = 9), s.ignoreCase && (n >>= 1)) : s.type === R.Pseudo && (s.data ? s.name === "has" || s.name === "contains" ? n = 0 : Array.isArray(s.data) ? (n = Math.min(...s.data.map((i) => Math.min(...i.map(GA)))), n < 0 && (n = 0)) : n = 2 : n = 3), n;
}
const Ou = /[-[\]{}()*+?.,\\^$|#\s]/g;
function Ao(s) {
  return s.replace(Ou, "\\$&");
...
function oe(s, t) {
  return typeof s.ignoreCase == "boolean" ? s.ignoreCase : s.ignoreCase === "quirks" ? !!t.quirksMode : !t.xmlMode && Qu.has(s.name);
}
const Gu = {
  equals(s, t, e) {
...
}, Lu = /* @__PURE__ */ new Set([9, 10, 12, 13, 32]), ao = 48, Ku = 57;
function Hu(s) {
  ...
  function o() {
    const c = t;
    let a = 0;
    for (; t < s.length && s.charCodeAt(t) >= ao && s.charCodeAt(t) <= Ku; )
      a = a * 10 + (s.charCodeAt(t) - ao), t++;
    return t === c ? null : a;
  }
  function A() {
    for (; t < s.length && Lu.has(s.charCodeAt(t)); )
      t++;
  }
}
function Wu(s) {
    ...
    if (A && c !== D.trueFunc) {
      ...
      return (g) => {
        if (!s(g))
          return !1;
        A[0] = g;
        const S = r.getChildren(g), b = u ? [...S, ...Uu(g, r)] : S;
...
function _u(s, t, e, n, i) {
  ...
  const c = (r = e.pseudos) === null || r === void 0 ? void 0 : r[o], a = typeof c == "string" ? c : Yu[o];
  if (typeof a == "string") {
    if (A != null)
...
function ju(s, { adapter: t }, e) {
  const n = !!e?.every((i) => {
    const r = t.isTag(i) && t.getParent(i);
    return i === LA || r && t.isTag(r);
  });
  for (const i of s) {
    if (!(i.length > 0 && Li(i[0]) && i[0].type !== R.Descendant)) if (n && !i.some(WA))
      i.unshift(Zu);
    else
      continue;
    i.unshift(Xu);
...
function YA(s, t, e) {
  var n;
  s.forEach(ku), e = (n = t.context) !== null && n !== void 0 ? n : e;
  const i = Array.isArray(e), r = e && (Array.isArray(e) ? e : [e]);
  if (t.relativeSelector !== !1)
    ju(s, t, r);
  else if (s.some((c) => c.length > 0 && Li(c[0])))
    throw new Error("Relative selectors are not allowed when the `relativeSelector` option is disabled");
  let o = !1;
  const A = s.map((c) => {
    if (c.length >= 2) {
      const [a, u] = c;
      a.type !== R.Pseudo || a.name !== "scope" || (i && u.type === R.Descendant ? c[1] = Vu : (u.type === R.Adjacent || u.type === R.Sibling) && (o = !0));
    }
    return qu(c, t, r);
  }).reduce(zu, D.falseFunc);
  return A.shouldTestNextSiblings = o, A;
}
function qu(s, t, e) {
  var n;
  return s.reduce((i, r) => i === D.falseFunc ? D.falseFunc : Ju(i, r, t, e, YA), (n = t.rootFunc) !== null && n !== void 0 ? n : D.trueFunc);
}
function zu(s, t) {
...
const { isArray: nh } = Array, nn = ({ nodeType: s }) => s === x, JA = (s, t) => t.some(
  (e) => nn(e) && (s(e) || JA(s, Fe(e)))
), ih = (s, t) => t === "class" ? s.classList.value : s.getAttribute(t), Fe = ({ childNodes: s }) => s, rh = (s) => {
  const { localName: t } = s;
  return $t(s) ? t.toLowerCase() : t;
}, oh = ({ parentNode: s }) => s, Ah = (s) => {
  const { parentNode: t } = s;
  return t ? Fe(t) : s;
}, bi = (s) => nh(s) ? s.map(bi).join("") : nn(s) ? bi(Fe(s)) : s.nodeType === it ? s.data : "", ah = (s, t) => s.hasAttribute(t), ch = (s) => {
  let { length: t } = s;
  for (; t--; ) {
    const e = s[t];
...
const uh = (s) => s instanceof de, On = (s, t, e) => {
...
const Ls = (s) => s.replace(/(([A-Z0-9])([A-Z0-9][a-z]))|(([a-z0-9]+)([A-Z]))/g, "$2$5-$3$6").toLowerCase(), Ks = /* @__PURE__ */ new WeakMap(), Qn = (s) => `data-${Ls(s)}`, hh = (s) => s.slice(5).replace(/-([a-z])/g, (t, e) => e.toUpperCase()), gh = {
  get(s, t) {
    if (t in s)
...
class ea {
  ...
  constructor(t) {
    for (const { name: e, value: n } of t.attributes)
      /^data-/.test(e) && (this[hh(e)] = n);
    return Ks.set(this, t), new Proxy(this, gh);
  }
}
ct(ea.prototype, null);
const { add: dh } = Set.prototype, uo = (s, t) => {
  for (const e of t)
    e && dh.call(s, e);
}, Pe = ({ [qo]: s, value: t }) => {
...
const Vs = /* @__PURE__ */ new WeakMap(), Ei = (s) => [...s.keys()].filter((t) => t !== nt), Xs = (s) => {
  ...
  get(s, t) {
    return t in ph ? s[t] : (Xs(s), t === "length" ? Ei(s).length : /^\d+$/.test(t) ? Ei(s)[t] : s.get(Ls(t)));
  },
  set(s, t, e) {
    if (t === "cssText")
      s[t] = e;
      ...
      let n = Xs(s);
      if (e == null ? s.delete(Ls(t)) : s.set(Ls(t), e), !n) {
        const i = Vs.get(s);
...
let sa = class extends Map {
  ...
  toString() {
    ...
    Xs(t);
    const e = [];
    return t.forEach(mh, e), e.join(";");
  }
};
const { prototype: ph } = sa;
function mh(s, t) {
  t !== nt && this.push(`${t}:${s}`);
}
...
}, bh = ({ localName: s, ownerDocument: t }) => t[Ne].voidElements.test(s);
let cs = class extends jA {
  ...
  get classList() {
    return this[Re] || (this[Re] = new fh(this));
  }
  get dataset() {
  ...
  get innerText() {
    ...
    let { [m]: e, [w]: n } = this;
    for (; e !== n; )
      e.nodeType === it ? t.push(e.textContent.replace(/\s+/g, " ")) : t.length && e[m] != n && Xl.has(e.tagName) && t.push(`
`), e = e[m];
    return t.join("");
  }
  /**
  ...
  toString() {
    ...
    do
      switch (n = n[m], n.nodeType) {
        ...
        case zt: {
          const r = n[ut];
          i ? ("ownerSVGElement" in r ? t.push(" />") : bh(r) ? t.push($t(r) ? ">" : " />") : t.push(`></${r.localName}>`), i = !1) : t.push(`</${r.localName}>`);
          break;
        }
        case x:
...
const Gn = /* @__PURE__ */ new WeakMap(), yh = {
  get(s, t) {
    return s[t];
  },
  set(s, t, e) {
...
let ts = class extends cs {
  ...
  get className() {
    return Gn.has(this) || Gn.set(this, new Proxy({ baseVal: "", animVal: "" }, yh)), Gn.get(this);
  }
  /* c8 ignore start */
  set className(t) {
    const { classList: e } = this;
...
class rn extends C {
  ...
  toString() {
    return wh.call(this.cloneNode()).replace("><", () => `>${this.textContent}<`);
  }
}
const oa = "script";
class Aa extends rn {
...
function ke() {
  ...
  }, Ln.CSSStyleDeclaration = s.CSSStyleDeclaration, s.parse = ir().parse, Ln;
}
var ii = {}, Lo;
function xh() {
  if (Lo) return ii;
...
class Ca extends rn {
  ...
  get sheet() {
    const t = this[Ie];
    return t !== null ? t : this[Ie] = vh.parse(this.textContent);
  }
  get innerHTML() {
...
var Ns = { exports: {} };
const Zh = {}, Vh = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Zh
}, Symbol.toStringTag, { value: "Module" })), Xh = /* @__PURE__ */ wu(Vh);
var ri, Ho;
function jh() {
  if (Ho) return ri;
  Ho = 1;
...
var zh = qh();
const $h = /* @__PURE__ */ MA(zh), { createCanvas: tg } = $h, Ra = "canvas";
class Ba extends C {
  constructor(t, e = Ra) {
    super(t, e), this[It] = tg(300, 150);
  }
  get width() {
...
const xg = {
  ...
  HTMLObjectElement: Bh,
  HTMLHeadElement: Th,
  HTMLBodyElement: Dh,
  HTMLStyleElement: Ca,
  HTMLTimeElement: ba,
  HTMLFieldSetElement: Fh,
  HTMLEmbedElement: Mh,
  HTMLHRElement: kh,
  HTMLProgressElement: Oh,
  HTMLParagraphElement: Qh,
  HTMLTableElement: Gh,
  HTMLFrameSetElement: Lh,
  HTMLLIElement: Kh,
  HTMLBaseElement: Hh,
  HTMLDataListElement: Wh,
  HTMLInputElement: Ea,
  HTMLParamElement: Yh,
  HTMLMediaElement: Uh,
  HTMLAudioElement: _h,
  HTMLHeadingElement: wa,
  HTMLDirectoryElement: Jh,
  HTMLQuoteElement: Ph,
  HTMLCanvasElement: Ba,
  HTMLLegendElement: eg,
  HTMLOptionElement: Da,
  HTMLSpanElement: sg,
  HTMLMeterElement: ng,
  HTMLVideoElement: ig,
  HTMLTableCellElement: rg,
  HTMLTitleElement: Na,
  HTMLOutputElement: og,
  ...
  HTMLUListElement: Sg,
  HTMLMetaElement: Ua,
  HTMLPictureElement: Cg,
  HTMLAreaElement: bg,
  HTMLOListElement: yg,
  HTMLTableCaptionElement: Eg,
  HTMLAnchorElement: Ja,
  HTMLLabelElement: Ig,
  HTMLUnknownElement: wg,
  HTMLModElement: Rg,
  HTMLDetailsElement: Bg,
...
let ge = class extends Ki {
  constructor(t) {
    super(null, "#document", Ae), this[Et] = { active: !1, registry: null }, this[Vt] = { active: !1, class: null }, this[Ne] = Ng[t], this[ie] = null, this[hi] = null, this[Os] = null, this[It] = null, this[qe] = null;
  }
  /**
      ...
      get: (t, e) => {
        switch (e) {
          ...
          case "window":
            return Fs.get(this);
          case "customElements":
            return this[Et].registry || (this[Et] = new uu(this)), this[Et];
          case "performance":
            return t.performance;
          case "DOMParser":
            return this[hi];
          case "Image":
            return this[It] || (this[It] = Fg(this)), this[It];
          case "MutationObserver":
            return this[Vt].class || (this[Vt] = new fu(this)), this[Vt].class;
        }
  ...
  createEvent(t) {
    const e = ou(t === "Event" ? new he("") : new Va(""));
...
class Qg extends ge {
  ...
  createElement(t, e) {
    const n = !!(e && e.is), i = Og(this, n, t, e);
...
class Ar {
  ...
  parseFromString(t, e, n = null) {
    let i = !1, r;
    return e === "text/html" ? (i = !0, r = new Qg()) : e === "image/svg+xml" ? r = new Gg() : r = new Lg(), r[hi] = Ar, n && (r[Os] = n), i && t === "..." && (t = "<!doctype html><html><head></head><body></body></html>"), t ? mA(r, i, t) : r;
  }
}
const Kg = (s, t = null) => new Ar().parseFromString(
  s,
  "text/html",
  t
).defaultView;
...
const Te = class Te {
  constructor(t, e, n) {
    ...
    if (Ee(this, ss, t), Ee(this, ns, e), Ee(this, Zt, ja({}, Mr(this, $s, za).bind(this))), e && Hs) {
...
ae = new WeakMap(), zs = new WeakMap(), vt = new WeakMap(), ss = new WeakMap(), ns = new WeakMap(), Zt = new WeakMap(), $s = new WeakSet(), za = function(t, e, n) {
...
const Ug = /([a-zA-Z-]+)\s*:\s*([^;}]+)/g, $a = "a-zA-Z_$", _g = $a + "0-9", es = `[${$a}][${_g}]*`, Jg = /<!--\s*(.*?)\s*-->/, Pg = /<(\w+)(?:\s[^>]*)?>((?:[^<]|<(?!\w))*?)<\/\1>/g, oi = new RegExp(`^this\\.${es}$`), Ai = new RegExp(`this\\.${es}(\\.${es})*`, "g"), js = new RegExp(`this\\.${es}(\\.${es})*`), Zg = 5;
function Vg(s) {
...
function ci(s, t, e) {
  const [n, i] = t.split(":");
  s instanceof CSSStyleRule ? s.style.setProperty(n, e) : (sc(s, n, e), n === "value" && ar(s) && (s.value = e));
}
async function zg(s) {
...
`;
  ...
  static ssr(t = {}) {
    ...
    const i = this.buildHTML(), { document: r } = Kg(i), o = r.querySelectorAll("*");
    for (const a of o) {
